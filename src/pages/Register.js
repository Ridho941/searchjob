    ...
    <div className='flex items-center justify-center min-h-screen bg-gray-100'>
      <div className='px-8 py-6 mx-4 mt-4 text-left bg-white rounded-lg shadow-lg md:w-1/3 lg:w-1/3 sm:w-1/3'>
        ...
        <form action="" onSubmit={registerHandler}>
          ...
          <button type='submit' className="w-full px-6 py-2 mt-4 text-white bg-green-600 rounded-lg hover:bg-green-900">Buat Akun</button>
          <p className="text-sm mt-4 font-light text-gray-500 dark:text-gray-400">
            Telah mempunyai akun? <a href="/login" className="font-medium text-primary-600 hover:underline text-green-600 dark:text-primary-500">Masuk disini</a>
          </p>
        </form>
      </div>
    </div>
