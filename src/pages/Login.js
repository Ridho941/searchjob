        ...
        <div className='flex items-center justify-center min-h-screen bg-gray-100 rounded-lg'>
            <div class="px-8 py-6 mx-4 mt-4 text-left bg-white rounded-lg shadow-lg md:w-1/3 lg:w-1/3 sm:w-1/3">
                ...
                <form action="">
                  ...
                  <button type="submit" class=" w-full px-6 py-2 mt-4 text-white bg-green-600 rounded-lg hover:bg-green-900">Masuk</button>
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400 mt-4">
                      Apakah anda belum punya akun? <a href="/register" class="font-medium text-primary-600 text-green-600 hover:underline dark:text-primary-500">Daftar</a>
                  </p>
